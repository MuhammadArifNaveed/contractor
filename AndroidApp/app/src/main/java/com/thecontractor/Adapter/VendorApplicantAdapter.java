...
public class VendorApplicantAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {

    private List<VendorApplicantListingModel> list;
        ...
        public ItemVH(final View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    VendorApplicantListingModel availableApplicantListingModel = list.get(pos);

                    Intent intent = new Intent(mContext , VendorApplicantDetail.class);
                    Bundle b = new Bundle();
                    b.putParcelable("availableApplicantListingModel", availableApplicantListingModel);
                    intent.putExtras(b);
    ...
    public VendorApplicantAdapter(Context context, List<VendorApplicantListingModel> list , String selectedLanguage) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == ITEM) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.vendor_applicant_custom_row, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        VendorApplicantListingModel model = list.get(position);
        ...
        switch (getItemViewType(position)) {
            case ITEM:
                ...
                if(selectedLanguage.equals("en"))
                {
                    ...
                    itemVH.city.setText(model.getUser_city_name());
...
//    }
    ...
    public void add(VendorApplicantListingModel r) {
        list.add(r);
    ...
    public void addAll(List<VendorApplicantListingModel> moveResults) {
        for (VendorApplicantListingModel result : moveResults) {
            add(result);
        }
    }
    ...
    public void addLoadingFooter() {
        isLoadingAdded = true;
        add(new VendorApplicantListingModel());
    }
    ...
    public void removeLoadingFooter() {
        ...
        VendorApplicantListingModel result = getItem(position);
    ...
    public VendorApplicantListingModel getItem(int position) {
