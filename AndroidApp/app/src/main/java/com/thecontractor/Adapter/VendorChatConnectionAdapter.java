...
public class VendorChatConnectionAdapter extends RecyclerView.Adapter<VendorChatConnectionAdapter.ViewHolder>  {
        ...
        public ViewHolder(final View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mContext , VendorChat.class);
                    intent.putExtra("userId" , list.get(pos).getUser_id());
                    intent.putExtra("userName" , list.get(pos).getUser_name());
                    intent.putExtra("userUUID" ,list.get(pos).getUser_uuid());
    ...
    public VendorChatConnectionAdapter(Context context, List<ChatConnectionModel> list , String selectedLanguage) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.chatUserName.setText(model.getUser_name());
        holder.chatLastMessage.setText(model.getLast_message());
        holder.chatLastMessageTime.setText(covertTimeToTextTe(model.getLast_message()));
