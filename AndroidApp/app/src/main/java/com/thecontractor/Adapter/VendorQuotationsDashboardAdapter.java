...
public class VendorQuotationsDashboardAdapter extends RecyclerView.Adapter<VendorQuotationsDashboardAdapter.ViewHolder>  {
        ...
        public ViewHolder(final View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mContext , VendorParticularQuotations.class);
                    Bundle b = new Bundle();
    ...
    public VendorQuotationsDashboardAdapter(Context context, List<VendorDashboardCountModel> list , String selectedLanguage) {
        this.list = list;
