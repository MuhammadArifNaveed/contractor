...
import com.thecontractor.VendorActivities.VendorJobListing;
import com.thecontractor.VendorActivities.VendorParticularQuotations;

import java.util.List;


public class VendorJobsDashboardAdapter extends RecyclerView.Adapter<VendorJobsDashboardAdapter.ViewHolder>  {
        ...
        public ViewHolder(final View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(mContext , VendorJobListing.class);
                    Bundle b = new Bundle();
    ...
    public VendorJobsDashboardAdapter(Context context, List<VendorDashboardCountModel> list , String selectedLanguage) {
        this.list = list;
