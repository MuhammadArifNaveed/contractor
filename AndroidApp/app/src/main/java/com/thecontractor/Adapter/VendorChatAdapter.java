...
public class VendorChatAdapter extends RecyclerView.Adapter<VendorChatAdapter.ViewHolder>  {
    ...
    public VendorChatAdapter(Context context, List<ChatModel> list , String selectedLanguage, String vendorUUID) {
        this.list = list;
