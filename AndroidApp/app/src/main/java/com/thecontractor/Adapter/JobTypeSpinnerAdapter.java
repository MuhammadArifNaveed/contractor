...
public class JobTypeSpinnerAdapter extends BaseAdapter {
    ...
    private List<VendorJobTypeModel> coreList;
    private LayoutInflater inflater;
    private String selectedLanguage;



    public JobTypeSpinnerAdapter(Context context, List<VendorJobTypeModel> list , String selectedLanguage) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        VendorJobTypeModel bean = coreList.get(i);


        if(selectedLanguage.equals("en"))
        {
            txtName.setText(bean.getType());
        }else
        {
            txtName.setText(bean.getType());
        }
