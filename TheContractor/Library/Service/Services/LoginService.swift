...
//        }
    ...
    /// Get integrations
    func getIntegrations(companyId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/integrations"
        let params: [String: String] = ["company_id": companyId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func configureIntegration(companyId: String, integrationId: String, apiKey: String?, webhookUrl: String?, isEnabled: Bool, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/configure_integration"
        var params: [String: String] = ["company_id": companyId, "integration_id": integrationId, "is_enabled": isEnabled ? "1" : "0"]
        if let apiKey = apiKey { params["api_key"] = apiKey }
        if let webhookUrl = webhookUrl { params["webhook_url"] = webhookUrl }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Get webhook events
    func getWebhookEvents(integrationId: String, pageNo: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/webhook_events"
        let params: [String: String] = ["integration_id": integrationId, "page_no": pageNo]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Get API logs
    func getAPILogs(dateFrom: String?, dateTo: String?, pageNo: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/api_logs"
        var params: [String: String] = ["page_no": pageNo]
        if let dateFrom = dateFrom { params["date_from"] = dateFrom }
        if let dateTo = dateTo { params["date_to"] = dateTo }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
    ...
    func getComplianceChecklists(companyId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/compliance_checklists"
        let params: [String: String] = ["company_id": companyId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func updateComplianceItem(itemId: String, isCompleted: Bool, documentUrl: String?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/update_compliance_item"
        var params: [String: String] = ["item_id": itemId, "is_completed": isCompleted ? "1" : "0"]
        if let documentUrl = documentUrl { params["document_url"] = documentUrl }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func getRegulatoryRequirements(category: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/regulatory_requirements"
        var params: [String: String] = [:]
        if let category = category { params["category"] = category }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    func reportComplianceViolation(companyId: String, violationType: String, severity: String, description: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/report_compliance_violation"
        let params: [String: String] = ["company_id": companyId, "violation_type": violationType, "severity": severity, "description": description]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func getAvailableResources(resourceType: String?, skillSet: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/available_resources"
        var params: [String: String] = [:]
        if let resourceType = resourceType { params["resource_type"] = resourceType }
        if let skillSet = skillSet { params["skill_set"] = skillSet }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Allocate resource
    func allocateResource(resourceId: String, projectId: String, startDate: String, endDate: String, allocationPercentage: String, role: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/allocate_resource"
        let params: [String: String] = ["resource_id": resourceId, "project_id": projectId, "start_date": startDate, "end_date": endDate, "allocation_percentage": allocationPercentage, "role": role]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func getResourceAllocations(projectId: String?, resourceId: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/resource_allocations"
        var params: [String: String] = [:]
        if let projectId = projectId { params["project_id"] = projectId }
        if let resourceId = resourceId { params["resource_id"] = resourceId }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func getResourceForecast(period: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/resource_forecast"
        let params: [String: String] = ["period": period]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Get announcements
    func getAnnouncements(targetAudience: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/announcements"
        var params: [String: String] = [:]
        if let targetAudience = targetAudience { params["target_audience"] = targetAudience }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Create announcement
    func createAnnouncement(title: String, titleArabic: String, message: String, messageArabic: String, targetAudience: String, priority: String, expiresAt: String?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/create_announcement"
        var params: [String: String] = ["title": title, "title_arabic": titleArabic, "message": message, "message_arabic": messageArabic, "target_audience": targetAudience, "priority": priority]
        if let expiresAt = expiresAt { params["expires_at"] = expiresAt }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Send bulk message
    func sendBulkMessage(subject: String, message: String, recipients: [String], sendMethod: String, scheduledFor: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/send_bulk_message"
        var params: [String: String] = ["subject": subject, "message": message, "send_method": sendMethod]
        if let scheduledFor = scheduledFor { params["scheduled_for"] = scheduledFor }
        for (index, recipient) in recipients.enumerated() {
            params["recipient\(index + 1)"] = recipient
        }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    /// Get newsletters
    func getNewsletters(category: String?, pageNo: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/newsletters"
        var params: [String: String] = ["page_no": pageNo]
        if let category = category { params["category"] = category }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    /// Get email templates
    func getEmailTemplates(category: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/email_templates"
        var params: [String: String] = [:]
        if let category = category { params["category"] = category }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    func getCommunicationLogs(recipientId: String?, messageType: String?, pageNo: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/communication_logs"
        var params: [String: String] = ["page_no": pageNo]
        if let recipientId = recipientId { params["recipient_id"] = recipientId }
        if let messageType = messageType { params["message_type"] = messageType }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func submitOnboardingApplication(companyName: String, companyNameArabic: String, applicantName: String, email: String, phone: String, businessType: String, yearEstablished: String, licenseNumber: String, documents: [Data]?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/submit_onboarding"
        let params: [String: String] = ["company_name": companyName, "company_name_arabic": companyNameArabic, "applicant_name": applicantName, "email": email, "phone": phone, "business_type": businessType, "year_established": yearEstablished, "license_number": licenseNumber]
        var fileDict: [String: Data] = [:]
        if let documents = documents {
            for (index, docData) in documents.enumerated() {
                fileDict["document\(index + 1)"] = docData
    ...
    func getOnboardingApplications(status: String?, pageNo: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/onboarding_applications"
        var params: [String: String] = ["page_no": pageNo]
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    func updateOnboardingStatus(applicationId: String, status: String, notes: String?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/update_onboarding_status"
        var params: [String: String] = ["application_id": applicationId, "status": status]
        if let notes = notes { params["notes"] = notes }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    ...
    func getVendorVerifications(companyId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/vendor_verifications"
        let params: [String: String] = ["company_id": companyId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func createQualityInspection(projectId: String, inspectionType: String, inspectorName: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/create_quality_inspection"
        let params: [String: String] = ["project_id": projectId, "inspection_type": inspectionType, "inspector_name": inspectorName]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func getQualityInspections(projectId: String?, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/quality_inspections"
        var params: [String: String] = [:]
        if let projectId = projectId { params["project_id"] = projectId }
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
    ...
    func submitInspectionFinding(inspectionId: String, category: String, severity: String, description: String, recommendation: String, images: [Data]?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/submit_inspection_finding"
        let params: [String: String] = ["inspection_id": inspectionId, "category": category, "severity": severity, "description": description, "recommendation": recommendation]
        var fileDict: [String: Data] = [:]
        if let images = images {
            for (index, imageData) in images.enumerated() {
                fileDict["image\(index + 1)"] = imageData
            }
        }
        self.makePostAPICallWithMultipart(with: completeURL, dict: fileDict, params: params, isImageData: !fileDict.isEmpty) { message, success, json in
            completion(message, success)
    ...
    func getQualityStandards(category: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/quality_standards"
        var params: [String: String] = [:]
        if let category = category { params["category"] = category }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    /// Get fleet vehicles
    func getFleetVehicles(companyId: String, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/fleet_vehicles"
        var params: [String: String] = ["company_id": companyId]
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    /// Add vehicle
    func addVehicle(companyId: String, vehicleType: String, make: String, model: String, year: String, registrationNumber: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/add_vehicle"
        let params: [String: String] = ["company_id": companyId, "vehicle_type": vehicleType, "make": make, "model": model, "year": year, "registration_number": registrationNumber]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Assign vehicle
    func assignVehicle(vehicleId: String, driverId: String, projectId: String?, purpose: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/assign_vehicle"
        var params: [String: String] = ["vehicle_id": vehicleId, "driver_id": driverId, "purpose": purpose]
        if let projectId = projectId { params["project_id"] = projectId }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func recordVehicleMaintenance(vehicleId: String, maintenanceType: String, description: String, cost: String, servicedBy: String, odometer: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/record_vehicle_maintenance"
        let params: [String: String] = ["vehicle_id": vehicleId, "maintenance_type": maintenanceType, "description": description, "cost": cost, "serviced_by": servicedBy, "odometer": odometer]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Add fuel log
    func addFuelLog(vehicleId: String, driverId: String, fuelType: String, quantity: String, cost: String, odometer: String, location: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/add_fuel_log"
        let params: [String: String] = ["vehicle_id": vehicleId, "driver_id": driverId, "fuel_type": fuelType, "quantity": quantity, "cost": cost, "odometer": odometer, "location": location]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func getTrainingCourses(category: String?, level: String?, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/training_courses"
        var params: [String: String] = [:]
        if let category = category { params["category"] = category }
    ...
    /// Enroll in course
    func enrollInCourse(userId: String, courseId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/enroll_in_course"
        let params: [String: String] = ["user_id": userId, "course_id": courseId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func getUserEnrollments(userId: String, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/user_enrollments"
        var params: [String: String] = ["user_id": userId]
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    /// Get course modules
    func getCourseModules(courseId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/course_modules"
        let params: [String: String] = ["course_id": courseId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Submit assessment
    func submitAssessment(courseId: String, userId: String, answers: [String: String], completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/submit_assessment"
        var params: [String: String] = ["course_id": courseId, "user_id": userId]
        for (questionId, answer) in answers {
            params["answer_\(questionId)"] = answer
        }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func getTrainingCertificates(userId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/training_certificates"
        let params: [String: String] = ["user_id": userId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    /// Submit expense
    func submitExpense(companyId: String, projectId: String?, categoryId: String, amount: String, currency: String, expenseDate: String, description: String, paymentMethod: String, receipt: Data?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/submit_expense"
        var params: [String: String] = ["company_id": companyId, "category_id": categoryId, "amount": amount, "currency": currency, "expense_date": expenseDate, "description": description, "payment_method": paymentMethod]
        if let projectId = projectId { params["project_id"] = projectId }
        var fileDict: [String: Data] = [:]
        if let receipt = receipt { fileDict["receipt"] = receipt }
        self.makePostAPICallWithMultipart(with: completeURL, dict: fileDict, params: params, isImageData: !fileDict.isEmpty) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Get expenses
    func getExpenses(companyId: String, projectId: String?, status: String?, pageNo: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/expenses"
        var params: [String: String] = ["company_id": companyId, "page_no": pageNo]
        if let projectId = projectId { params["project_id"] = projectId }
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    /// Approve expense
    func approveExpense(expenseId: String, status: String, notes: String?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/approve_expense"
        var params: [String: String] = ["expense_id": expenseId, "status": status]
        if let notes = notes { params["notes"] = notes }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    ...
    /// Get expense report
    func getExpenseReport(companyId: String, dateFrom: String, dateTo: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/expense_report"
        let params: [String: String] = ["company_id": companyId, "date_from": dateFrom, "date_to": dateTo]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func getProjectMilestones(projectId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/project_milestones"
        let params: [String: String] = ["project_id": projectId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Create milestone
    func createMilestone(projectId: String, milestoneName: String, description: String, targetDate: String, assignedTo: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/create_milestone"
        let params: [String: String] = ["project_id": projectId, "milestone_name": milestoneName, "description": description, "target_date": targetDate, "assigned_to": assignedTo]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func updateMilestoneProgress(milestoneId: String, progress: String, status: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/update_milestone_progress"
        let params: [String: String] = ["milestone_id": milestoneId, "progress": progress, "status": status]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func getProjectTimeline(projectId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/project_timeline"
        let params: [String: String] = ["project_id": projectId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    /// Get warranties
    func getWarranties(companyId: String?, projectId: String?, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/warranties"
        var params: [String: String] = [:]
        if let companyId = companyId { params["company_id"] = companyId }
        if let projectId = projectId { params["project_id"] = projectId }
        if let status = status { params["status"] = status }
    ...
    /// File warranty claim
    func fileWarrantyClaim(warrantyId: String, userId: String, issueDescription: String, priority: String, images: [Data]?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/file_warranty_claim"
        let params: [String: String] = ["warranty_id": warrantyId, "user_id": userId, "issue_description": issueDescription, "priority": priority]
        var fileDict: [String: Data] = [:]
        if let images = images {
            for (index, imageData) in images.enumerated() {
                fileDict["image\(index + 1)"] = imageData
    ...
    /// Get warranty claims
    func getWarrantyClaims(warrantyId: String?, userId: String?, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/warranty_claims"
        var params: [String: String] = [:]
        if let warrantyId = warrantyId { params["warranty_id"] = warrantyId }
        if let userId = userId { params["user_id"] = userId }
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    func scheduleWarrantyInspection(warrantyId: String, inspectorName: String, inspectionDate: String, inspectionType: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/schedule_warranty_inspection"
        let params: [String: String] = ["warranty_id": warrantyId, "inspector_name": inspectorName, "inspection_date": inspectionDate, "inspection_type": inspectionType]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Get service history
    func getServiceHistory(userId: String, companyId: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/service_history"
        var params: [String: String] = ["user_id": userId]
        if let companyId = companyId { params["company_id"] = companyId }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    /// Add service record
    func addServiceRecord(userId: String, companyId: String, serviceType: String, description: String, cost: String, technicianName: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/add_service_record"
        let params: [String: String] = ["user_id": userId, "company_id": companyId, "service_type": serviceType, "description": description, "cost": cost, "technician_name": technicianName]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func getMaintenanceSchedule(userId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/maintenance_schedule"
        let params: [String: String] = ["user_id": userId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func createServiceReport(serviceRecordId: String, workPerformed: String, recommendations: String, parts: [[String: String]]?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/create_service_report"
        var params: [String: String] = ["service_record_id": serviceRecordId, "work_performed": workPerformed, "recommendations": recommendations]
        if let parts = parts {
            for (index, part) in parts.enumerated() {
                for (key, value) in part {
                    params["part\(index + 1)_\(key)"] = value
                }
            }
        }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
    ...
    func sendServiceReminder(userId: String, assetId: String, reminderType: String, message: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/send_service_reminder"
        let params: [String: String] = ["user_id": userId, "asset_id": assetId, "reminder_type": reminderType, "message": message]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func requestEmergencyService(userId: String, serviceType: String, urgencyLevel: String, location: String, latitude: String, longitude: String, description: String, contactNumber: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/request_emergency_service"
        let params: [String: String] = ["user_id": userId, "service_type": serviceType, "urgency_level": urgencyLevel, "location": location, "latitude": latitude, "longitude": longitude, "description": description, "contact_number": contactNumber]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func getEmergencyRequests(userId: String?, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/emergency_requests"
        var params: [String: String] = [:]
        if let userId = userId { params["user_id"] = userId }
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
    ...
    func respondToEmergency(requestId: String, companyId: String, technicianName: String, technicianPhone: String, estimatedArrival: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/respond_to_emergency"
        let params: [String: String] = ["request_id": requestId, "company_id": companyId, "technician_name": technicianName, "technician_phone": technicianPhone, "estimated_arrival": estimatedArrival]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func getEmergencyContacts(serviceCategory: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/emergency_contacts"
        var params: [String: String] = [:]
        if let serviceCategory = serviceCategory { params["service_category"] = serviceCategory }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func updateEmergencyStatus(requestId: String, status: String, notes: String?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/update_emergency_status"
        var params: [String: String] = ["request_id": requestId, "status": status]
        if let notes = notes { params["notes"] = notes }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    ...
    /// Get company assets
    func getCompanyAssets(companyId: String, category: String?, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/company_assets"
        var params: [String: String] = ["company_id": companyId]
        if let category = category { params["category"] = category }
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
    ...
    /// Add asset
    func addAsset(companyId: String, assetName: String, assetType: String, assetCode: String, category: String, purchaseDate: String, purchasePrice: String, location: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/add_asset"
        let params: [String: String] = ["company_id": companyId, "asset_name": assetName, "asset_type": assetType, "asset_code": assetCode, "category": category, "purchase_date": purchaseDate, "purchase_price": purchasePrice, "location": location]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Transfer asset
    func transferAsset(assetId: String, toLocation: String, reason: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/transfer_asset"
        let params: [String: String] = ["asset_id": assetId, "to_location": toLocation, "reason": reason]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func getAssetDepreciation(assetId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/asset_depreciation"
        let params: [String: String] = ["asset_id": assetId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Conduct asset audit
    func conductAssetAudit(companyId: String, auditorName: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/conduct_asset_audit"
        let params: [String: String] = ["company_id": companyId, "auditor_name": auditorName]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Dispose asset
    func disposeAsset(assetId: String, disposalMethod: String, reason: String, disposalValue: String?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/dispose_asset"
        var params: [String: String] = ["asset_id": assetId, "disposal_method": disposalMethod, "reason": reason]
        if let disposalValue = disposalValue { params["disposal_value"] = disposalValue }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func getSafetyTrainings(category: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/safety_trainings"
        var params: [String: String] = [:]
        if let category = category { params["category"] = category }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    func enrollSafetyTraining(userId: String, trainingId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/enroll_safety_training"
        let params: [String: String] = ["user_id": userId, "training_id": trainingId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func conductSiteInspection(projectId: String, inspectorName: String, inspectionType: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/conduct_site_inspection"
        let params: [String: String] = ["project_id": projectId, "inspector_name": inspectorName, "inspection_type": inspectionType]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func reportSafetyIncident(projectId: String, incidentType: String, severity: String, description: String, reportedBy: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/report_safety_incident"
        let params: [String: String] = ["project_id": projectId, "incident_type": incidentType, "severity": severity, "description": description, "reported_by": reportedBy]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func getMaterialsCatalog(category: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/materials_catalog"
        var params: [String: String] = [:]
        if let category = category { params["category"] = category }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    func createProcurementRequest(projectId: String, requestedBy: String, requiredDate: String, items: [[String: String]], completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/create_procurement_request"
        var params: [String: String] = ["project_id": projectId, "requested_by": requestedBy, "required_date": requiredDate]
        for (index, item) in items.enumerated() {
            for (key, value) in item {
                params["item\(index + 1)_\(key)"] = value
            }
    ...
    /// Get suppliers
    func getSuppliers(specialization: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/suppliers"
        var params: [String: String] = [:]
        if let specialization = specialization { params["specialization"] = specialization }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Create purchase order
    func createPurchaseOrder(procurementRequestId: String, supplierId: String, deliveryDate: String, paymentTerms: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/create_purchase_order"
        let params: [String: String] = ["procurement_request_id": procurementRequestId, "supplier_id": supplierId, "delivery_date": deliveryDate, "payment_terms": paymentTerms]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    // MARK: - Change Orders
    /// Submit change order
    func submitChangeOrder(projectId: String, description: String, reason: String, impactOnSchedule: String, impactOnCost: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/submit_change_order"
        let params: [String: String] = ["project_id": projectId, "description": description, "reason": reason, "impact_on_schedule": impactOnSchedule, "impact_on_cost": impactOnCost]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Get change orders
    func getChangeOrders(projectId: String, status: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/change_orders"
        var params: [String: String] = ["project_id": projectId]
        if let status = status { params["status"] = status }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    func createRiskAssessment(projectId: String, riskCategory: String, riskDescription: String, likelihood: String, impact: String, mitigationPlan: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/create_risk_assessment"
        let params: [String: String] = ["project_id": projectId, "risk_category": riskCategory, "risk_description": riskDescription, "likelihood": likelihood, "impact": impact, "mitigation_plan": mitigationPlan]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    // MARK: - Site Logistics
    /// Schedule delivery
    func scheduleDelivery(projectId: String, supplierId: String, deliveryDate: String, materialDescription: String, quantity: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/schedule_delivery"
        let params: [String: String] = ["project_id": projectId, "supplier_id": supplierId, "delivery_date": deliveryDate, "material_description": materialDescription, "quantity": quantity]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Record site access
    func recordSiteAccess(projectId: String, personName: String, company: String, purpose: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/record_site_access"
        let params: [String: String] = ["project_id": projectId, "person_name": personName, "company": company, "purpose": purpose]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    /// Deploy equipment
    func deployEquipment(projectId: String, equipmentType: String, equipmentName: String, assignedTo: String, location: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/deploy_equipment"
        let params: [String: String] = ["project_id": projectId, "equipment_type": equipmentType, "equipment_name": equipmentName, "assigned_to": assignedTo, "location": location]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Submit site report
    func submitSiteReport(projectId: String, weatherConditions: String, workersPresent: String, workCompleted: String, images: [Data]?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Admin/submit_site_report"
        let params: [String: String] = ["project_id": projectId, "weather_conditions": weatherConditions, "workers_present": workersPresent, "work_completed": workCompleted]
        var fileDict: [String: Data] = [:]
        if let images = images {
            for (index, imageData) in images.enumerated() {
                fileDict["image\(index + 1)"] = imageData
    ...
    func getProjectProgress(projectId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/project_progress"
        let params: [String: String] = ["project_id": projectId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func updatePhaseProgress(phaseId: String, progress: String, status: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/update_phase_progress"
        let params: [String: String] = ["phase_id": phaseId, "progress": progress, "status": status]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Add work log
    func addWorkLog(projectId: String, hoursWorked: String, taskDescription: String, progressPercentage: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/add_work_log"
        let params: [String: String] = ["project_id": projectId, "hours_worked": hoursWorked, "task_description": taskDescription, "progress_percentage": progressPercentage]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func uploadProgressPhoto(projectId: String, phaseId: String, description: String, image: Data, latitude: String?, longitude: String?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/upload_progress_photo"
        var params: [String: String] = ["project_id": projectId, "phase_id": phaseId, "description": description]
        if let latitude = latitude { params["latitude"] = latitude }
        if let longitude = longitude { params["longitude"] = longitude }
        let fileDict: [String: Data] = ["photo": image]
        self.makePostAPICallWithMultipart(with: completeURL, dict: fileDict, params: params, isImageData: true) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Get subcontractors
    func getSubcontractors(specialization: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/subcontractors"
        var params: [String: String] = [:]
        if let specialization = specialization { params["specialization"] = specialization }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    func createSubcontractorAgreement(projectId: String, subcontractorId: String, scopeOfWork: String, startDate: String, endDate: String, contractValue: String, paymentTerms: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/create_subcontractor_agreement"
        let params: [String: String] = ["project_id": projectId, "subcontractor_id": subcontractorId, "scope_of_work": scopeOfWork, "start_date": startDate, "end_date": endDate, "contract_value": contractValue, "payment_terms": paymentTerms]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func submitSubcontractorInvoice(agreementId: String, invoiceNumber: String, amount: String, workDescription: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/submit_subcontractor_invoice"
        let params: [String: String] = ["agreement_id": agreementId, "invoice_number": invoiceNumber, "amount": amount, "work_description": workDescription]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func rateSubcontractorPerformance(subcontractorId: String, projectId: String, qualityRating: String, timelinessRating: String, safetyRating: String, comments: String?, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/rate_subcontractor"
        var params: [String: String] = ["subcontractor_id": subcontractorId, "project_id": projectId, "quality_rating": qualityRating, "timeliness_rating": timelinessRating, "safety_rating": safetyRating]
        if let comments = comments { params["comments"] = comments }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Record attendance
    func recordAttendance(userId: String, projectId: String, checkInTime: String, location: String?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/record_attendance"
        var params: [String: String] = ["user_id": userId, "project_id": projectId, "check_in_time": checkInTime]
        if let location = location { params["location"] = location }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    /// Check out
    func checkOut(attendanceId: String, checkOutTime: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/check_out"
        let params: [String: String] = ["attendance_id": attendanceId, "check_out_time": checkOutTime]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Submit timesheet
    func submitTimesheet(userId: String, weekStartDate: String, weekEndDate: String, entries: [[String: String]], completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/submit_timesheet"
        var params: [String: String] = ["user_id": userId, "week_start_date": weekStartDate, "week_end_date": weekEndDate]
        for (index, entry) in entries.enumerated() {
            for (key, value) in entry {
                params["entry\(index + 1)_\(key)"] = value
            }
        }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
    ...
    /// Request leave
    func requestLeave(userId: String, leaveType: String, startDate: String, endDate: String, reason: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/request_leave"
        let params: [String: String] = ["user_id": userId, "leave_type": leaveType, "start_date": startDate, "end_date": endDate, "reason": reason]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func createCostEstimate(projectId: String, estimateNumber: String, contingency: String, categories: [[String: Any]], completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/create_cost_estimate"
        var params: [String: String] = ["project_id": projectId, "estimate_number": estimateNumber, "contingency": contingency]
        for (catIndex, category) in categories.enumerated() {
            if let catName = category["name"] as? String {
                params["category\(catIndex + 1)_name"] = catName
            }
            if let items = category["items"] as? [[String: String]] {
                for (itemIndex, item) in items.enumerated() {
                    for (key, value) in item {
                        params["category\(catIndex + 1)_item\(itemIndex + 1)_\(key)"] = value
                    }
                }
            }
        }
    ...
    /// Get budget variance
    func getBudgetVariance(projectId: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/budget_variance"
        let params: [String: String] = ["project_id": projectId]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    ...
    func generateCostForecast(projectId: String, estimatedCompletion: String, projectedCost: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/generate_cost_forecast"
        let params: [String: String] = ["project_id": projectId, "estimated_completion": estimatedCompletion, "projected_cost": projectedCost]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    func scheduleClientMeeting(projectId: String, clientName: String, meetingDate: String, meetingType: String, agenda: String, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/schedule_client_meeting"
        let params: [String: String] = ["project_id": projectId, "client_name": clientName, "meeting_date": meetingDate, "meeting_type": meetingType, "agenda": agenda]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success, json)
        }
    }
    ...
    func submitClientFeedback(projectId: String, category: String, rating: String, comments: String, completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Home/submit_client_feedback"
        let params: [String: String] = ["project_id": projectId, "category": category, "rating": rating, "comments": comments]
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
            completion(message, success)
        }
    }
    ...
    /// Send project update
    func sendProjectUpdate(projectId: String, subject: String, message: String, recipients: [String], completion: @escaping (_ message: String, _ success: Bool) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/send_project_update"
        var params: [String: String] = ["project_id": projectId, "subject": subject, "message": message]
        for (index, recipient) in recipients.enumerated() {
            params["recipient\(index + 1)"] = recipient
        }
        self.makePostAPICallWithMultipart(with: completeURL, dict: nil, params: params, isImageData: false) { message, success, json in
    ...
    func requestClientApproval(projectId: String, approvalType: String, description: String, requiredBy: String, document: Data?, completion: @escaping (_ message: String, _ success: Bool, _ json: JSON?) -> Void) {
        let completeURL = EndPoints.BASE_URL + "Vendor/request_client_approval"
        let params: [String: String] = ["project_id": projectId, "approval_type": approvalType, "description": description, "required_by": requiredBy]
        var fileDict: [String: Data] = [:]
        if let document = document { fileDict["document"] = document }
        self.makePostAPICallWithMultipart(with: completeURL, dict: fileDict, params: params, isImageData: !fileDict.isEmpty) { message, success, json in
            completion(message, success, json)
        }
    }
