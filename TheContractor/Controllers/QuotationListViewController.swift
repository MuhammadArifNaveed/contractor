...
extension QuotationListViewController : UITableViewDataSource , UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "QuotationDetailsTableViewCell", for: indexPath) as! QuotationDetailsTableViewCell
        return cell
    }
