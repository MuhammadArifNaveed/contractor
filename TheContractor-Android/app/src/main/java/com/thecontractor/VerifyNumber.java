...
public class VerifyNumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.verify_number));
    ...
    public void initiate()
    {
        ...
        progressDialog = new ProgressDialog(VerifyNumber.this);
    ...
    public void clickListener()
    {
        btnSendCode.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                ...
                if(phoneNumber.equals("3124611478") || phoneNumber.equals("3024507881") || phoneNumber.equals("3034937427") )
                {
                ...
                {
                    Toast.makeText(VerifyNumber.this, getResources().getString(R.string.phone_no_error), Toast.LENGTH_SHORT).show();
                } else {
...
//                    Intent intent;
//                    intent = new Intent(VerifyNumber.this, Register.class);
//                    intent.putExtra("phoneNumber"  , mFullNumberWithCode);
//                    startActivity(intent);
//                    finish();


                    loginService(mFullNumberWithCode);
        ...
        btnVerifyCode.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                ...
                if (verificationCode.isEmpty())
                {
                    ...
                    Toast.makeText(VerifyNumber.this, getResources().getString(R.string.please_try_again), Toast.LENGTH_SHORT).show();
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onCodeSent(String verificationId, PhoneAuthProvider.ForceResendingToken token)
            {
                ...
                Toast.makeText(VerifyNumber.this, getResources().getString(R.string.verification_code_sent), Toast.LENGTH_SHORT).show();
    ...
    {
        AlertDialog alertDialog = new AlertDialog.Builder(VerifyNumber.this).create();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        else
                        {
                            ...
                            //Toast.makeText(VerifyNumber.this, message, Toast.LENGTH_SHORT).show();


                            Log.e("tag" , "alert message is : "+message);
    ...
    private void ResendCode()
    {
        ...
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setActivity(VerifyNumber.this)                 // Activity (for callback binding)
                        .setCallbacks(mCallbacks)          // OnVerificationStateChangedCallbacks
                        .build();
        PhoneAuthProvider.verifyPhoneNumber(options);

//        PhoneAuthProvider.getInstance().verifyPhoneNumber(
//                mFullNumberWithCode,        // Phone number to verify
//                60,                 // Timeout duration
//                TimeUnit.SECONDS,   // Unit of timeout
//                VerifyNo.this,               // Activity (for callback binding)
...
//                mResendToken);
    ...
    private void loginService(String phone) {
        ...
        call.enqueue(new Callback<BasicResponseModel>() {
            ...
            public void onFailure(Call<BasicResponseModel> call, Throwable t) {
                ...
                {
                    hideProgress();
                    Toast.makeText(VerifyNumber.this , getResources().getString(R.string.serviceError), Toast.LENGTH_LONG).show();
