...
public class Complaints extends AppCompatActivity {
    ...
    public void getLanguageFromSP() {
        if (!SharedPrefManager.getInstance(Complaints.this).getUserLanguage().equals("")) {
            selectedLanguage = SharedPrefManager.getInstance(Complaints.this).getUserLanguage();
    ...
    public void getDataFromSP() {
        if (!SharedPrefManager.getInstance(Complaints.this).getUserObject().equals("")) {
            Gson gson = new Gson();
            String json = SharedPrefManager.getInstance(Complaints.this).getUserObject();
    ...
    public void initiate()
    {
        ...
        complaintsRV = (RecyclerView) findViewById(R.id.complaintsRV);
        linearLayoutManager = new LinearLayoutManager(Complaints.this  , LinearLayoutManager.VERTICAL , false);
        complaintsRV.setLayoutManager(linearLayoutManager);
        complaintsAdapter = new ComplaintsAdapter(Complaints.this , list , selectedLanguage);
        complaintsRV.setAdapter(complaintsAdapter);
    }

    private void complaintsAPI(final boolean firstTimeCall) {
        ...
        call = retrofitApi.recentComplaints(user_id , page);
        ...
        call.enqueue(new Callback<BasicResponseModel>() {
            ...
            public void onResponse(Call<BasicResponseModel> call, Response<BasicResponseModel> response) {
                ...
                if(response.isSuccessful())
                {
                    if(response.body().getError().equals("false")) {
                        ...
                        list = response.body().getComplaints();
                        lastPage = response.body().getTotal_page();

                        Log.e("tag" , "complaints list size is : "+list.size());
                ...
                {
                    Toast.makeText(Complaints.this, getResources().getString(R.string.please_try_again), Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<BasicResponseModel> call, Throwable t) {
                ...
                {
                    hideProgress();
                    Toast.makeText(Complaints.this , getResources().getString(R.string.serviceError), Toast.LENGTH_LONG).show();
    ...
    public void recyclerViewPaginationScroller()
    {
        ...
        complaintsRV.addOnScrollListener(new PaginationScrollListener(linearLayoutManager) {
            @Override
