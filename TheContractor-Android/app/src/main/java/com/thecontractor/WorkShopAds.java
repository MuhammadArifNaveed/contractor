...
public class WorkShopAds extends AppCompatActivity {
    String type;
    String vendorId;
    String userId;
    String userType;
    ...
    WorkshopAdAdapter workshopAdAdapter;
    int currentPage = 1;
    int lastPage = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_work_shop_ads);
    ...
    public void getDataFromActivity(){
        ...
        Log.e("tag" , "workshop ad from is : "+type);
    }

    public void getLanguageFromSP() {
        if (!SharedPrefManager.getInstance(WorkShopAds.this).getUserLanguage().equals("")) {
            selectedLanguage = SharedPrefManager.getInstance(WorkShopAds.this).getUserLanguage();
    ...
    public void getUserDataFromSP() {
        if (!SharedPrefManager.getInstance(WorkShopAds.this).getUserObject().equals("")) {
            Gson gson = new Gson();
            String json = SharedPrefManager.getInstance(WorkShopAds.this).getUserObject();
    ...
    public void getVendorDataFromSP() {
        if (!SharedPrefManager.getInstance(WorkShopAds.this).getVendorObject().equals("")) {
            Gson gson = new Gson();
            String json = SharedPrefManager.getInstance(WorkShopAds.this).getVendorObject();
    ...
    {
        progressDialog = new ProgressDialog(WorkShopAds.this);
        ...
        linearLayoutManager = new LinearLayoutManager(WorkShopAds.this  , LinearLayoutManager.VERTICAL , false);
        workshopRV.setLayoutManager(linearLayoutManager);
        workshopAdAdapter = new WorkshopAdAdapter(WorkShopAds.this , list , selectedLanguage);
        workshopRV.setAdapter(workshopAdAdapter);
    }
    ...
    public void clickListener(){
        openBid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openBid.setBackground(ContextCompat.getDrawable(WorkShopAds.this, R.drawable.button_bacground));
                closeBid.setBackground(ContextCompat.getDrawable(WorkShopAds.this, R.drawable.outline_black_button_bacground));
                noData.setVisibility(GONE);
                from = "open";
                currentPage = 1;
                lastPage = 0;
        ...
        closeBid.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                closeBid.setBackground(ContextCompat.getDrawable(WorkShopAds.this, R.drawable.button_bacground));
                openBid.setBackground(ContextCompat.getDrawable(WorkShopAds.this, R.drawable.outline_black_button_bacground));
                noData.setVisibility(GONE);
                from = "close";
                currentPage = 1;
                lastPage = 0;
    ...
    private void workshopAdAPI(final boolean firstTimeCall) {
        ...
        call = retrofitApi.workshopAds(vendor_id , user_id , user_type , bid_type , page);
        ...
        call.enqueue(new Callback<BasicResponseModel>() {
            ...
            public void onResponse(Call<BasicResponseModel> call, Response<BasicResponseModel> response) {
                ...
                if(response.isSuccessful())
                {
                    if(response.body().getError().equals("false")) {
                        ...
                        if(!firstTimeCall)
                        {
                            workshopAdAdapter.removeLoadingFooter();
                            isLoading = false;
                        }else
                        {
                        ...
                        workshopAdAdapter.addAll(list);

                        if (lastPage != currentPage)
                        {
                            workshopAdAdapter.addLoadingFooter();
                        }
                        else
                        {
                            isLastPage = true;
                ...
                {
                    Toast.makeText(WorkShopAds.this, getResources().getString(R.string.please_try_again), Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<BasicResponseModel> call, Throwable t) {
                ...
                {
                    hideProgress();
                    Toast.makeText(WorkShopAds.this , getResources().getString(R.string.serviceError), Toast.LENGTH_LONG).show();
