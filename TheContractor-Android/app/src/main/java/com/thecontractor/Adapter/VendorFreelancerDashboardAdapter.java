...
public class VendorFreelancerDashboardAdapter extends RecyclerView.Adapter<VendorFreelancerDashboardAdapter.ViewHolder>  {
    ...
    public VendorFreelancerDashboardAdapter(Context context, List<VendorDashboardCountModel> list , String selectedLanguage) {
        this.list = list;
