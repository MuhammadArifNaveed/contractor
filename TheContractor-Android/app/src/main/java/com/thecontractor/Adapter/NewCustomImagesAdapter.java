...
public class NewCustomImagesAdapter extends RecyclerView.Adapter<NewCustomImagesAdapter.ImageViewHolder> {

    private Context context;
    private List<NewCustomImagesModel> images;
    private LayoutInflater inflater;
    private DeleteImage deleteImage;

    public NewCustomImagesAdapter(Context context , DeleteImage deleteImage) {
    ...
    public void onBindViewHolder(ImageViewHolder holder, int position) {
        final NewCustomImagesModel image = images.get(position);
        Glide.with(context)
                //.load(image.getPath())
                .load(image.getUri())
    ...
    public void setData(List<NewCustomImagesModel> images) {
        this.images.clear();
        if (images != null) {
