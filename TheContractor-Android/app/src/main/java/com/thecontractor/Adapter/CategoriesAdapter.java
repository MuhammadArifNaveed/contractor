...
public class CategoriesAdapter extends RecyclerView.Adapter<CategoriesAdapter.ViewHolder>  {
    ...
    public CategoriesAdapter(Context context, List<CategoriesModel> list , SubCategoriesInterface subCategoriesInterface , String selectedLanguage) {
        this.list = list;
        this.mContext = context;
        this.subCategoriesInterface = subCategoriesInterface;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = null;
        itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.categories_custom_row, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        {
            subCategoriesInterface.selectedSubCategories(model.getSub_categories() , model.getId());
    ...
    public interface SubCategoriesInterface
    {
        void selectedSubCategories(ArrayList<SubCategoriesModel> sub_categories, String categoryId);
    }
}
